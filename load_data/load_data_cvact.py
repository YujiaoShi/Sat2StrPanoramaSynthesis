...
def load_examples(mode='train', batch_size=2):
    ...
    if mode=='train':
        ...
        aer_list = [img_root + 'satview_correct/' + item[1] for item in valList if item[0] in exist_grd_list and item[1] in exist_aer_list]
        ...
        #             item[0] in exist_grd_list and item[1] in exist_aer_list]
        tanpolar_list = [img_root + 'a2g_correct/' + item[1] for item in valList if
                    item[0] in exist_grd_list and item[1] in exist_aer_list]
